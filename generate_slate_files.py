...
columns = {}
columns["person"] = ["Ref","SIS ID","Preferred","First","Middle","Last","Suffix","Alias","Birthdate","Sex","IPEDS","Race","Primary Citizenship","noodleCrmId",
                    "Street 1","Street 2","City","Region","Postal","Zip Code (Stand Alone)","Country","Prospect Status","Initial Inquiry","Tags",
                    "prospectFull-Time/PartTimeIntent","Anticipated Start Term","Person Updated","Highest Level of Education","Years of Work Experience",
                    "Interaction Date","Interaction Summary","Degree of Interest",
                    "Institution Email",
...
columns["application"] = ["Application ID","Ref","Campus","Academic Program","Application Status",
                          ...
                          "All Missing Checklist Items","All Waived Checklist Items","All Fulfilled Checklist Items",
